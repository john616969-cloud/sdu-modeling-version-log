  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border bg-card p-5 shadow-[0_14px_40px_rgb(18_45_85/6%)] sm:p-6">
      ...
      {entry ? <>
        ...
        <Button className="mt-5 h-10 w-full sm:w-auto" render={<a aria-label={`下载 ${entry.version}`} href={`/api/files?path=${encodeURIComponent(entry.repository_path ?? '')}`} />}><Download />下载这一版</Button>
